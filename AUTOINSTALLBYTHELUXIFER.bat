...
echo ‘ª çª ... †„…Œ‘!;
	...
	echo Ÿ ˆŠ€—“)
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://185.237.96.243/bms/BMS.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	echo ‘ª çª ... †„…Œ‘!;
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://185.237.96.243/bms/xen.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
