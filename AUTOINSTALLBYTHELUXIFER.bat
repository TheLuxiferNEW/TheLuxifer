...
echo ‘ª çª ... †„…Œ‘!;
	...
	echo Ÿ ˆŠ€—“)
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://130.193.36.153/bms/BMS.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	echo ‘ª çª ... †„…Œ‘!;
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://130.193.36.153/bms/xen.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://130.193.36.153/bms/scripts.7z"
	...
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://130.193.36.153/bms/resource.7z"
	...
	"C:\Users\haker\Desktop\wget.exe" --no-check-certificate "http://130.193.36.153/bms/1817140991.7z"
