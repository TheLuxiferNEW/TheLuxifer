...
echo ‘ª çª ... †„…Œ‘!;
	...
	echo Ÿ ˆŠ€—“)
	wget.exe --no-check-certificate "http://130.193.36.153/BMS.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	echo ‘ª çª ... †„…Œ‘!;
	wget.exe --no-check-certificate "http://130.193.36.153/xen.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	wget.exe --no-check-certificate "http://130.193.36.153/scripts.7z"
	...
	wget.exe --no-check-certificate "http://130.193.36.153/resource.7z"
	...
	wget.exe --no-check-certificate "http://130.193.36.153/1817140991.7z"
