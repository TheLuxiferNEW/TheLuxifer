...
echo ‘ª çª ... †„…Œ‘!;
	...
	echo Ÿ ˆŠ€—“)
	wget.exe --no-check-certificate "http://130.193.36.153/bms/BMS.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	echo ‘ª çª ... †„…Œ‘!;
	wget.exe --no-check-certificate "http://130.193.36.153/bms/xen.7z"
	echo ‘Š€—Š€ ˜‹€ “‘…˜, €—ˆ€ €‘€Š‚Š“.
	...
	wget.exe --no-check-certificate "http://130.193.36.153/bms/scripts.7z"
	...
	wget.exe --no-check-certificate "http://130.193.36.153/bms/resource.7z"
	...
	wget.exe --no-check-certificate "http://130.193.36.153/bms/1817140991.7z"
